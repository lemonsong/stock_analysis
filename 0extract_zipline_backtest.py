...
def run_strategies(stocks, start_date, end_date, bundle_name, output_dir):
    ...
    if summary_results:
        ...
        print(f"Summary saved to {os.path.join(output_dir, 'summary.csv')}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", default="data_tushare_kline", help="Input directory for stock data")
    ...
    parser.add_argument("--end_date", default="2025-10-28", help="End date (YYYY-MM-DD)")

    args = parser.parse_args()

    input_dir = args.input_dir
    # Handle if input_dir is data_tushare_kline but data is in data_tushare_kline/daily
